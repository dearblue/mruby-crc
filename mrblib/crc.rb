...
class CRC
  ...
  define_crc_module("CRC16_RIELLO",       16,             "1021",     "554d", true,  true,     0)
  define_crc_module("CRC16_TELEDISK",     16,             "a097",          0, false, false,    0)
  define_crc_module("CRC16_TMS37157",     16,             "1021",     "3791", true,  true,     0)
  define_crc_module("CRC16_USB",          16,             "8005",          0, true,  true,    ~0)
  define_crc_module("CRC16_A",            16,             "1021",     "6363", true,  true,     0)
  ...
  define_crc_module("CRC24_BLE",          24,         "0000065b", "00aaaaaa", true,  true,     0)
